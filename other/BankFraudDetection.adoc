...
Most of the problem can be solved by looking beyond the individual documents to the collections of them and the connections they form. In other words, to put them in context. 
