...
Graphs can represent very complex relationships.  Documents are graphs.  The best way to handle documents is as lists of {kv}s that render into the full document.  See {Cmorg}.
